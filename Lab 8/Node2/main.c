...
int main(void)
{
	...
	while (1) 
    {
		...
		//if ((timer_read() - prev_time_reading)/656 >= T){
		//	pid_controller1(message.data[1]); // Need to store this somewhere to fetch when running PID
		//	prev_time_reading = timer_read();
		//}
